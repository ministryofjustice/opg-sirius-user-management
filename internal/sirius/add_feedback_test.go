...
func TestAddFeedback(t *testing.T) {
	...
	testCases := []struct {
		...
		//						"name":                  "testteam",
		//						"email":                 "@example.com",
		//						"caseNumber":            "12345",
		//						"message":               "content",
		//					},
		//				}).
		...
		//		},
		//		name:       "testteam",
		//		email:      "",
		//		caseNumber: "12345",
		//		feedback:   "content",
