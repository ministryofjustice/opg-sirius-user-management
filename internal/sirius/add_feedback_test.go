	...
	testCases := []struct {
	...
	}{
		{
			...
			setup: func() {
				pact.
					...
					WithCompleteRequest(consumer.Request{
						...
						Path:   matchers.String("/supervision-api/v1/feedback/supervision"),
			...
			expectedError: func(port int) error {
				return StatusError{Code: 403, URL: fmt.Sprintf("http://127.0.0.1:%d/supervision-api/v1/feedback/supervision", port), Method: http.MethodPost}
			},
		},
	}
...
func TestAddFeedbackCanHandleBadRequest(t *testing.T) {
	...
	assert.Equal(t, StatusError{
		...
		URL:    svr.URL + "/supervision-api/v1/feedback/supervision",
		Method: http.MethodPost,
	}, err)
}
