...
func TestValidationErrorUnmarshalled(t *testing.T) {
    ...
    "validation_errors": {
        "dob": {
            "invalid-lt": "This must be before 17/06/2024"
        }
    },
	...
	expectedResponse := ValidationError{Message: "", Errors: ValidationErrors{"dob": map[string]string{"invalid-lt": "This must be before 17/06/2024"}}}
